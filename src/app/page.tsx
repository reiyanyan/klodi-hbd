            ...
            <>
              <div className="absolute top-1/2 h-full w-full">
                ...
                <div className="h-screen flex flex-col items-center text-center justify-center px-4 md:px-8 bg-gradient-to-b from-[#303952] to-black">
                  <div className="w-full md:w-1/2 bg-[url('https://ik.imagekit.io/3592mo0vh/img/8.jpg')] bg-cover bg-center rounded-lg">
                    <p className="backdrop-blur-sm md:backdrop-blur-md py-16 md:py-36 px-5 md:px-20 rounded-lg">
